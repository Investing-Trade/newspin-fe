                    ...
                    <div className="md:col-span-9 border-2 border-black rounded-lg p-1 bg-white flex flex-col h-full overflow-hidden">
                        ...
                        {/* 학습 종료 및 재학습 버튼 */}
                         <div className="flex gap-20 mt-1 w-[50%] ml-60 items-center justify-center">
                            ...
                            {/* 악재 버튼 */}
                            <button className="flex-1 flex items-center border-2 border-white justify-center gap-2 bg-red-500 border-1 text-white active:scale-[0.98] transition-all rounded-lg font-semibold text-lg shadow-lg cursor-pointer hover:bg-rose-600">
