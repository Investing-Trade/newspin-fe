    ...
    return (
        <div className="w-full h-screen bg-blue-700 flex flex-col items-center md:p-2 font-agbalumo overflow-hidden">
            ...
            <div className="w-full max-w-7xl bg-white rounded-xl shadow-2xl p-6 flex flex-col gap-4 border-4 border-gray-400 flex-1 overflow-hidden">
                ...
                {/* 상단 섹션: 투자 설정 & 뉴스 기사 */}
                <div className="flex flex-[0.8] gap-6 overflow-hidden">
                    {/* 1. 투자 환경 설정 */}
                    <div className="flex-1 border-2 border-gray-300 rounded-lg p-3 relative bg-white">
                        <div className="flex items-center gap-2 mb-3">
                            <span className="text-xl">📊</span>
                            <h3 className="font-bold text-lg">투자 환경 설정</h3>
                            <button className="bg-blue-600 text-white text-xs px-2 py-1 rounded-md flex items-center gap-1">
                                📊 투자 시작
                            </button>
                ...
                {/* 하단 섹션: 차트 & 피드백 */}
                <div className="flex flex-[1.2] gap-6 overflow-hidden">
                    {/* 3. 차트 정보 및 거래 */}
                    <div className="flex-[1.2] border-2 border-gray-300 rounded-lg p-3 flex flex-col bg-white overflow-hidden">
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <div className="border border-gray-400 px-3 py-1 text-sm font-bold bg-gray-50">
                                현재 날짜 : 2021-03-03
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 border-t pt-2">
                            <div>
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="text-xs ml-auto">잔액 <span className="border border-gray-400 px-2 py-0.5 ml-1">3,950,000 원</span></span>
                                </div>
                                ...
                                <div className="grid grid-cols-4 gap-1">
                                    ...
                                    <select className="border text-[9px] rounded"><option>선택</option></select>
                                    <select className="border text-[9px] rounded"><option>선택</option></select>
                                    <select className="border text-[9px] rounded"><option>선택</option></select>
                                </div>
                            </div>
                            <div className="flex flex-col gap-1 items-end text-xs font-jua">
                                ...
                                <div className="flex gap-2 w-full mt-1">
                                    <button className="flex-1 bg-blue-600 text-white rounded-md py-1 font-bold shadow-md hover:bg-blue-800">매수</button>
                                    <button className="flex-1 bg-red-500 text-white rounded-md py-1 font-bold shadow-md hover:bg-red-700">매도</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* 4. 투자 결과 및 피드백 */}
                    <div className="flex-1 border-2 border-gray-300 rounded-lg p-3 bg-white flex flex-col overflow-hidden">
                ...
                <div className="flex justify-between items-center px-4 pt-2 border-t mt-auto shrink-0 font-jua">
                    <div className="flex gap-3">
                        <button className="bg-indigo-500 text-white px-4 py-2 rounded-xl text-xs font-bold flex items-center gap-2 shadow-md hover:bg-indigo-700">
                           <span className="text-lg">📅</span> 다음 날짜
                        </button>
                        <button onClick={() => navigate('/')} className="bg-indigo-600 text-white px-4 py-2 rounded-xl text-xs font-bold flex items-center gap-2 shadow-md hover:bg-indigo-800">
                           <span className="text-lg">🏠</span> 메인 화면 이동
                        </button>
                    </div>
                    <div className="flex gap-3">
                        <button className="bg-slate-700 text-white px-4 py-2 rounded-xl text-xs font-bold flex items-center gap-2 shadow-md">
                           <span className="text-lg">📊</span> 투자 결과 및 피드백
                        </button>
                        <button className="bg-blue-600 text-white px-4 py-2 rounded-xl text-xs font-bold flex items-center gap-2 shadow-md hover:bg-blue-800">
