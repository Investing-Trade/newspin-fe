...
// 추가적으로 필요한 아이콘들을 import 하거나 적절한 이미지를 사용하세요.
...
const Invest = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#6374f2] flex flex-col items-center p-8 font-sans">
      ...
      <div className="w-full max-w-6xl flex justify-between items-start mb-14">
        <div className="flex items-center gap-4">
          ...
          <div className="relative w-24 h-24">
            <img src={predictiveAnalytics} alt="analysis" className='w-20'/>
             <img src={businessMan} alt="man" className="w-20 h-auto drop-shadow-md" />
             <img src={webAnalytics} alt="chart" className="absolute -right-24 top-0 w-24 h-auto" />
          </div>
          <h1 className="text-white text-7xl font-agbalumo italic tracking-tight font-serif ml-4 ">NewsPin</h1>
        </div>
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        {/* 1. 뉴스 학습 카드 */}
        <div className="bg-white rounded-[2rem] p-10 flex flex-col items-center shadow-xl min-h-[550px]">
